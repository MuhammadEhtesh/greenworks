      ...
      <div className="container">
        <div className="row p-2 p-xxl-5 p-lg-5 ">
          <div className="col-lg-7 col-md-12 col-sm-12 d-flex justify-content-center align-items-center">
            <div className="col-lg-9 col-md-12 col-sm-12">
              ...
              <div className="row mt-4">
                <div className="col-6 ">
                  <div className="row">
                    <div className="col-1 " style={{ width: "36px" }}>
                      <span>
                ...
                <div className="col-6 ">
                  <div className="row">
                    <div className="col-1 d-flex " style={{ width: "36px" }}>
                      <span>
                        <img
                          style={{ width: "23px" }}
                          src={construction}
                ...
                <div className="col-6 ">
                  <div className="row">
                    ...
                    <div className="col d-flex justify-content-start">
                      <p className="position-relative iconname">
                        Infrared <br />
                        <span
          ...
          <div className="col-lg-5 col-md-12 col-sm-12 d-flex justify-content-center align-items-start">
            <div
              className="sideimage2 d-flex justify-content-end  mt-5 mt-lg-0 mt-md-5 mt-sm-5"
              style={{ height: "470px", width: "380px" }}
            >
              <img className="mt-2 mx-2" height={170} src={newimg} alt="" />
            </div>
          </div>
        </div>
      </div>
