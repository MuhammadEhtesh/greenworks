      ...
      <div className="col-7 d-flex justify-content-end align-items-center">
        <div className="col-9">
          <div className="row">
            ...
            <h1 style={{fontSize:"44px"}} className="fw-bold my-0 p-0">Commercial Services</h1>
            <h4 style={{fontSize:"26px",color:"#AA0101"}} className="my-0 p-0">types of Commercial inspections</h4>
          </div>
