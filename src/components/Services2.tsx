        ...
        <div className="sideimage1" style={{height:"410px",width:"340px"}}></div>
          ...
          <div className="col-lg-7 col-md-12 col-sm-12 d-flex justify-content-start align-items-center">
            <div className="col-lg-9 col-md-12 col-sm-12">
              ...
              <div className="row">
                <div className="col-4" style={{height:"max-content"}}>
                  <img className="images" style={{marginLeft:"-10px"}} src={Image3} alt="" />
                </div>
                <div className="col-4" style={{height:"max-content"}}>
                  <img className="images" style={{marginLeft:"-10px"}} src={Image2} alt="" />
                </div>
                <div className="col-4" style={{height:"max-content"}}>
                  <img className="images" style={{marginLeft:"-10px"}} src={Image1} alt="" />
                </div>
              </div>
            </div>
          </div>
